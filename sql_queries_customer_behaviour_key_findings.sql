...
SELECT 
	item_purchased,
	ROUND(AVG(review_rating::numeric),2)  average_rating
FROM customers
...
SELECT 
	shipping_type,
	ROUND(AVG(purchase_amount::NUMERIC),2) average_purchase_amount
FROM customers
...
SELECT
	...
	subscription_status,
	ROUND(AVG(purchase_amount),2) average_purchase_amount,
	SUM(purchase_amount) total_revenue
FROM customers
GROUP BY 2 ORDER BY 3,4 DESC;
